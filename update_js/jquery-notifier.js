(function($) {
    ...
    $.fn.notifier = (function() {
        ...
        var notification = (function() {
            return {
                styles: {
                    wrapper: 'position:fixed; top: 20px; left: 20px; line-height: 1.2; z-index: 999;',
                    notification: 'opacity: 0.0, display: none; position: relative; width: 40vh; padding: 25px; margin-bottom: 20px; z-index: 999; box-shadow: 0 2px 5px 0 rgba(0,0,0,0.16),0 2px 10px 0 rgba(0,0,0,0.12); transition: all, 0.3s;',
