! function(t) {
    ...
    t.cleanData = function(e) {
        ...
        var o, s, r, a, l = {},
            h = e.split(".")[0];
        return e = e.split(".")[1], o = h + "-" + e, n || (n = i, i = t.Widget), t.expr[":"][o.toLowerCase()] = function(e) {
            return !!t.data(e, o)
        }, t[h] = t[h] || {}, s = t[h][e], r = t[h][e] = function(t, e) {
        ...
        t.fn[e] = function(s) {
            var r = "string" == typeof s,
                ...
                l = this;
            return s = !r && a.length ? t.widget.extend.apply(null, [s].concat(a)) : s, this.each(r ? function() {
            ...
            _mouseDown: function(e) {
                if (!s) {
                    ...
                    return n && !o && this._mouseCapture(e) ? (this.mouseDelayMet = !this.options.delay, this.mouseDelayMet || (this._mouseDelayTimer = setTimeout(function() {
                        ...
                        return i._mouseUp(t)
                    }, this.document.bind("mousemove." + this.widgetName, this._mouseMoveDelegate).bind("mouseup." + this.widgetName, this._mouseUpDelegate), e.preventDefault(), s = !0, !0)) : !0
                }
            },
        ...
        function() {
            ...
            t.position = {
                    ...
                    return b = n(_), _[0].preventDefault && (o.at = "left top"), m = b.width, g = b.height, v = b.offset, y = t.extend({}, v), t.each(["my", "at"], function() {
                        ...
                        1 === i.length && (i = h.test(i[0]) ? i.concat(["center"]) : c.test(i[0]) ? ["center"].concat(i) : ["center", "center"]), i[0] = h.test(i[0]) ? i[0] : "center", i[1] = c.test(i[1]) ? i[1] : "center", t = u.exec(i[0]), e = u.exec(i[1]), E[this] = [t ? t[0] : 0, e ? e[0] : 0], o[this] = [f.exec(i[0])[0], f.exec(i[1])[0]]
                    }), 1 === C.length && (C[1] = C[0]), "right" === o.at[0] ? y.left += m : "center" === o.at[0] && (y.left += m / 2), "bottom" === o.at[1] ? y.top += g : "center" === o.at[1] && (y.top += g / 2), d = e(E.at, m, g), y.left += d[0], y.top += d[1], this.each(function() {
                        var n, h, c = t(this),
                            u = c.outerWidth(),
                            f = c.outerHeight(),
                            p = i(this, "marginLeft"),
                            b = i(this, "marginTop"),
                            P = u + p + i(this, "marginRight") + x.width,
                            S = f + b + i(this, "marginBottom") + x.height,
                            k = t.extend({}, y),
                            M = e(E.my, c.outerWidth(), c.outerHeight());
                        "right" === o.my[0] ? k.left -= u : "center" === o.my[0] && (k.left -= u / 2), "bottom" === o.my[1] ? k.top -= f : "center" === o.my[1] && (k.top -= f / 2), k.left += M[0], k.top += M[1], s || (k.left = l(k.left), k.top = l(k.top)), n = {
                            marginLeft: p,
                            marginTop: b
                            ...
                            u > m && m > a(e + i) && (l.horizontal = "center"), f > g && g > a(n + s) && (l.vertical = "middle"), l.important = r(a(e), a(i)) > r(a(n), a(s)) ? "horizontal" : "vertical", o.using.call(this, t, l)
                        }), c.offset(t.extend(k, {
                            using: h
                        }))
                    })
                    ...
                    flip: {
                        left: function(t, e) {
                            var i, n, o = e.within,
                                ...
                                p = -2 * e.offset[0];
                            0 > c ? (i = t.left + f + d + p + e.collisionWidth - r - s, (0 > i || a(c) > i) && (t.left += f + d + p)) : u > 0 && (n = t.left - e.collisionPosition.marginLeft + f + d + p - l, (n > 0 || u > a(n)) && (t.left += f + d + p))
                        },
                        top: function(t, e) {
                            var i, n, o = e.within,
                                ...
                                m = -2 * e.offset[1];
                            0 > c ? (n = t.top + d + p + m + e.collisionHeight - r - s, t.top + d + p + m > c && (0 > n || a(c) > n) && (t.top += d + p + m)) : u > 0 && (i = t.top - e.collisionPosition.marginTop + d + p + m - l, t.top + d + p + m > u && (i > 0 || u > a(i)) && (t.top += d + p + m))
                        }
                    },
                    flipfit: {
                        left: function() {
            ...
            drag: function(e, i, n) {
                t.each(n.sortables, function() {
                    ...
                    })), o ? (s.isOver || (s.isOver = 1, s.currentItem = i.helper.appendTo(s.element).data("ui-sortable-item", !0), s.options._helper = s.options.helper, s.options.helper = function() {
                        return i.helper[0]
            ...
            drag: function(e, i, n) {
                var o, s, r, a, l, h, c, u, f, d, p = n.options,
                    m = p.snapTolerance,
                    g = i.offset.left,
                    v = g + n.helperProportions.width,
                    y = i.offset.top,
                    b = y + n.helperProportions.height;
                for (f = n.snapElements.length - 1; f >= 0; f--) l = n.snapElements[f].left - n.margins.left, h = l + n.snapElements[f].width, c = n.snapElements[f].top - n.margins.top, u = c + n.snapElements[f].height, l - m > v || g > h + m || c - m > b || y > u + m || !t.contains(n.snapElements[f].item.ownerDocument, n.snapElements[f].item) ? (n.snapElements[f].snapping && n.options.snap.release && n.options.snap.release.call(n.element, e, t.extend(n._uiHash(), {
                    snapItem: n.snapElements[f].item
                })), n.snapElements[f].snapping = !1) : ("inner" !== p.snapMode && (o = m >= Math.abs(c - b), s = m >= Math.abs(u - y), r = m >= Math.abs(l - v), a = m >= Math.abs(h - g), o && (i.position.top = n._convertPositionTo("relative", {
                    ...
                    top: 0,
                    left: h
                }).left)), d = o || s || r || a, "outer" !== p.snapMode && (o = m >= Math.abs(c - y), s = m >= Math.abs(u - b), r = m >= Math.abs(l - g), a = m >= Math.abs(h - v), o && (i.position.top = n._convertPositionTo("relative", {
                    top: c,
                    left: 0
                }).top), s && (i.position.top = n._convertPositionTo("relative", {
                ...
                }).left)), !n.snapElements[f].snapping && (o || s || r || a || d) && n.options.snap.snap && n.options.snap.snap.call(n.element, e, t.extend(n._uiHash(), {
                    snapItem: n.snapElements[f].item
                })), n.snapElements[f].snapping = o || s || r || a || d)
            }
            ...
            _createHandles: function() {
                var e, i, n = this.options,
                    ...
                    r = [];
                for (i = n.values && n.values.length || 1, o.length > i && (o.slice(i).remove(), o = o.slice(0, i)), e = o.length; i > e; e++) r.push(s);
            ...
            _mouseCapture: function(e) {
                ...
                return u.disabled ? !1 : (this.elementSize = {
                    ...
                    (o > i || o === i && (e === c._lastChangedValue || c.values(e) === u.min)) && (o = i, s = t(this), r = e)
                }), a = this._start(e, r), a === !1 ? !1 : (this._mouseSliding = !0, this._handleIndex = r, s.addClass("ui-state-active").focus(), l = s.offset(), h = !t(e.target).parents().addBack().is(".ui-slider-handle"), this._clickOffset = h ? {
                    left: 0,
                    top: 0
                } : {
            ...
            _slide: function(t, e, i) {
                var n, o, s;
                this.options.values && this.options.values.length ? (n = this.values(e ? 0 : 1), 2 === this.options.values.length && this.options.range === !0 && (0 === e && i > n || 1 === e && n > i) && (i = n), i !== this.values(e) && (o = this.values(), o[e] = i, s = this._trigger("slide", t, {
                    handle: this.handles[e],
                    value: i,
                    values: o
                }), n = this.values(e ? 0 : 1), s !== !1 && this.values(e, i))) : i !== this.value() && (s = this._trigger("slide", t, {
                    handle: this.handles[e],
                    value: i
                }), s !== !1 && this.value(i))
            },
            ...
            _refreshValue: function() {
                ...
                }) : (n = this.value(), o = this._valueMin(), s = this._valueMax(), i = s !== o ? 100 * ((n - o) / (s - o)) : 0, c["horizontal" === this.orientation ? "left" : "bottom"] = i + "%", this.handle.stop(1, 1)[h ? "animate" : "css"](c, a.animate), "min" === r && "horizontal" === this.orientation && this.range.stop(1, 1)[h ? "animate" : "css"]({
                    width: i + "%"
            ...
            _handleEvents: {
                keydown: function(e) {
                    var i, n, o, s, r = t(e.target).data("ui-slider-handle-index");
                    switch (e.keyCode) {
                    ...
                    switch (s = this.options.step, n = o = this.options.values && this.options.values.length ? this.values(r) : this.value(), e.keyCode) {
                        case t.ui.keyCode.HOME:
                            o = this._valueMin();
                            break;
                        case t.ui.keyCode.END:
    ...
    t.effects = {
        ...
        function(t, e) {
            ...
            function n(i) {
                var n = h(),
                    o = n._rgba = [];
                return i = i.toLowerCase(), p(l, function(t, s) {
                    var r, a = s.re.exec(i),
                        l = a && s.parse(a),
                        h = s.space || "rgba";
                    return l ? (r = n[h](l), n[c[h].cache] = r[c[h].cache], o = n._rgba = r._rgba, !1) : e
            ...
            d.style.cssText = "background-color:rgba(1,1,1,.5)", f.rgba = d.style.backgroundColor.indexOf("rgba") > -1, p(c, function(t, e) {
                ...
                parse: function(o, r, a, l) {
                    ...
                    var u = this,
                        f = t.type(o),
                        d = this._rgba = [];
                    return r !== e && (o = [o, r, a, l], f = "array"), "string" === f ? this.parse(n(o) || s._default) : "array" === f ? (p(c.rgba.props, function(t, e) {
                        d[e.idx] = i(o[e.idx], e)
                    }), this) : "object" === f ? (o instanceof h ? p(c, function(t, e) {
                ...
                is: function(t) {
                    ...
                    return p(c, function(t, s) {
                        var r, a = i[s.cache];
                        return a && (r = o[s.cache] || s.to && s.to(o._rgba) || [], p(s.props, function(t, i) {
                ...
                transition: function(t, e) {
                    ...
                    return n = n[s.cache], p(s.props, function(t, o) {
                        var s = o.idx,
                            ...
                            h = n[s],
                            c = u[o.type] || {};
                        null !== h && (null === r ? l[s] = h : (c.mod && (h - r > c.mod / 2 ? r += c.mod : r - h > c.mod / 2 && (r -= c.mod)), l[s] = i((h - r) * e + r, o)))
                    }), this[o](l)
                },
                blend: function(e) {
                ...
                var e, i, n = t[0] / 255,
                    ...
                    c = a + l,
                    u = .5 * c;
                return e = l === a ? 0 : n === a ? 60 * (o - s) / h + 360 : o === a ? 60 * (s - n) / h + 120 : 60 * (n - o) / h + 240, i = 0 === h ? 0 : .5 >= u ? h / c : h / (2 - c), [Math.round(e) % 360, i, u, null == r ? 1 : r]
                ...
                h.fn[n] = function(n) {
                    ...
                    return p(s, function(t, e) {
                        ...
                        null == n && (n = f[e.idx]), f[e.idx] = i(n, e)
                    }), c ? (o = h(c(f)), o[r] = f, o) : h(f)
                }, p(s, function(e, i) {
                    h.fn[e] || (h.fn[e] = function(o) {
                        var s, r = t.type(o),
                            ...
                            h = this[l](),
                            c = h[i.idx];
                        return "undefined" === r ? c : ("function" === r && (o = o.call(this, c), r = t.type(o)), null == o && i.empty ? this : ("string" === r && (s = a.exec(o), s && (o = c + parseFloat(s[2]) * ("+" === s[1] ? 1 : -1))), h[i.idx] = o, this[l](h)))
                    })
                })
            }), h.hook = function(e) {
                var i = e.split(" ");
        ...
        function() {
            ...
            "show" === d && r.show(), n = {
            ...
            }, "toggle" === e.mode && "show" === d ? (r.from = e.to || b, r.to = e.from || n) : (r.from = e.from || ("show" === d ? b : n), r.to = e.to || ("hide" === d ? b : n)), s = {
                from: {
            ...
            }, ("box" === m || "both" === m) && (s.from.y !== s.to.y && (y = y.concat(u), r.from = t.effects.setTransition(r, u, s.from.y, r.from), r.to = t.effects.setTransition(r, u, s.to.y, r.to)), s.from.x !== s.to.x && (y = y.concat(f), r.from = t.effects.setTransition(r, f, s.from.x, r.from), r.to = t.effects.setTransition(r, f, s.to.x, r.to))), ("content" === m || "both" === m) && s.from.y !== s.to.y && (y = y.concat(c).concat(h), r.from = t.effects.setTransition(r, c, s.from.y, r.from), r.to = t.effects.setTransition(r, c, s.to.y, r.to)), t.effects.save(r, y), r.show(), t.effects.createWrapper(r), r.css("overflow", "hidden").css(r.from), g && (o = t.effects.getBaseline(g, n), r.from.top = (n.outerHeight - r.outerHeight()) * o.y, r.from.left = (n.outerWidth - r.outerWidth()) * o.x, r.to.top = (n.outerHeight - r.to.outerHeight) * o.y, r.to.left = (n.outerWidth - r.to.outerWidth) * o.x), r.css(r.from), ("content" === m || "both" === m) && (u = u.concat(["marginTop", "marginBottom"]).concat(c), f = f.concat(["marginLeft", "marginRight"]), h = a.concat(u).concat(f), r.find("*[width]").each(function() {
                var i = t(this),
                    n = {
                        height: i.height(),
                        width: i.width(),
                ...
                }, s.from.y !== s.to.y && (i.from = t.effects.setTransition(i, u, s.from.y, i.from), i.to = t.effects.setTransition(i, u, s.to.y, i.to)), s.from.x !== s.to.x && (i.from = t.effects.setTransition(i, f, s.from.x, i.from), i.to = t.effects.setTransition(i, f, s.to.x, i.to)), i.css(i.from), i.animate(i.to, e.duration, e.easing, function() {
                ...
                easing: e.easing,
                complete: function() {
                    0 === r.to.opacity && r.css("opacity", r.from.opacity), "hide" === d && r.hide(), t.effects.restore(r, y), p || ("static" === v ? r.css({
                        position: "relative",
                        top: r.to.top,
                        left: r.to.left
            ...
            t.effects.save(o, s), o.show(), n = e.distance || o["top" === h ? "outerHeight" : "outerWidth"](!0), t.effects.createWrapper(o).css({
                overflow: "hidden"
            }), a && o.css(h, c ? isNaN(n) ? "-" + n : -n : n), u[h] = (a ? c ? "+=" : "-=" : c ? "-=" : "+=") + n, o.animate(u, {
                queue: !1,
                duration: e.duration,
                easing: e.easing,
                complete: function() {
    ...
    function e(e) {
        var r = e || window.event,
            ...
            p = 0,
            m = 0;
        if (e = t.event.fix(r), e.type = "mousewheel", "detail" in r && (f = -1 * r.detail), "wheelDelta" in r && (f = r.wheelDelta), "wheelDeltaY" in r && (f = r.wheelDeltaY), "wheelDeltaX" in r && (u = -1 * r.wheelDeltaX), "axis" in r && r.axis === r.HORIZONTAL_AXIS && (u = -1 * f, f = 0), h = 0 === f ? u : f, "deltaY" in r && (f = -1 * r.deltaY, h = f), "deltaX" in r && (u = r.deltaX, 0 === f && (h = -1 * u)), 0 !== f || 0 !== u) {
            if (1 === r.deltaMode) {
            ...
            if (d = Math.max(Math.abs(f), Math.abs(u)), (!s || s > d) && (s = d, n(r, d) && (s /= 40)), n(r, d) && (h /= 40, u /= 40, f /= 40), h = Math[h >= 1 ? "floor" : "ceil"](h / s), u = Math[u >= 1 ? "floor" : "ceil"](u / s), f = Math[f >= 1 ? "floor" : "ceil"](f / s), c.settings.normalizeOffset && this.getBoundingClientRect) {
                var y = this.getBoundingClientRect();
                p = e.clientX - y.left, m = e.clientY - y.top
            }
            return e.deltaX = u, e.deltaY = f, e.deltaFactor = s, e.offsetX = p, e.offsetY = m, e.deltaMode = 0, a.unshift(e, h, u, f), o && clearTimeout(o), o = setTimeout(i, 200), (t.event.dispatch || t.event.handle).apply(this, a)
        }
    }
    ...
    t.fn.extend({
        ...
        function h(t, e, i) {
            var n = t.charAt(0).toUpperCase() + t.slice(1),
                o = (t + " " + E.join(n + " ") + n).split(" ");
            return s(e, "string") || s(e, "undefined") ? a(o, e) : (o = (t + " " + P.join(n + " ") + n).split(" "), l(o, e, i))
        }
        var c, u, f, d = "2.8.3",
            p = {},
            m = !0,
            ...
            T = M.slice,
            N = function(t, i, n, o) {
                var s, r, a, l, h = e.createElement("div"),
                    c = e.body,
                    u = c || e.createElement("body");
                if (parseInt(n, 10))
                    for (; n--;) a = e.createElement("div"), a.id = o ? o[n] : v + (n + 1), h.appendChild(a);
                return s = ["&#173;", '<style id="s', v, '">', t, "</style>"].join(""), h.id = v, (c ? h : u).innerHTML += s, u.appendChild(h), c || (u.style.background = "", u.style.overflow = "hidden", l = g.style.overflow, g.style.overflow = "hidden", g.appendChild(u)), r = i(h, t), c ? h.parentNode.removeChild(h) : (u.parentNode.removeChild(u), g.style.overflow = l), !!r
            },
            H = function() {
                function t(t, o) {
            ...
            O = {}.hasOwnProperty;
        f = s(O, "undefined") || s(O.call, "undefined") ? function(t, e) {
            ...
            return n((t + "-webkit- ".split(" ").join(e + t) + x.join(i + t)).slice(0, -t.length)), r(b.backgroundImage, "gradient")
            ...
            var t = !!h("perspective");
            return t && "webkitPerspective" in g.style && N("@media (transform-3d),(-webkit-transform-3d){#modernizr{left:9px;position:absolute;height:3px;}}", function(e) {
        ...
        for (var W in k) f(k, W) && (u = W.toLowerCase(), p[u] = k[W](), M.push((p[u] ? "" : "no-") + u));
        return p.addTest = function(t, e) {
            ...
            function(t, e) {
                ...
                function s(t, i, n) {
                    ...
                    n || (n = o(i));
                    var s;
                    return s = n.cache[t] ? n.cache[t].cloneNode() : p.test(t) ? (n.cache[t] = n.createElem(t)).cloneNode() : n.createElem(t), !s.canHaveChildren || d.test(t) || s.tagUrn ? s : n.frag.appendChild(s)
                }
                ...
                t.html5 = y, l(e)
            }(this, e), p._version = d, p._prefixes = x, p._domPrefixes = P, p._cssomPrefixes = E, p.hasEvent = H, p.testProp = function(t) {
                return a([t])
            }, p.testAllProps = h, p.testStyles = N, g.className = g.className.replace(/(^|\s)no-js(\s|$)/, "$1$2") + (m ? " js " + M.join(" ") : ""), p
    }(this, this.document),
    function(t, e, i) {
        function n(t) {
        ...
        function l(t, i, n, o, s, l, h) {
            ...
            1 === S[i] && (g = 1, S[i] = []), "object" == t ? u.data = i : (u.src = i, u.type = t), u.width = u.height = "0", u.onerror = u.onload = u.onreadystatechange = function() {
                c.call(this, g)
            }, v.splice(o, 0, b), "img" != t && (g || 2 === S[i] ? (w.insertBefore(u, _ ? null : m), p(c, h)) : S[i].push(u))
        }
        ...
        f = function(t) {
            function e(t) {
                ...
                for (i = 0; r > i; i++) n = t[i].split("="), (e = k[n.shift()]) && (s = e(s, n));
                for (i = 0; o > i; i++) s = P[i](s);
                return s
            }
            ...
            function r(t, o, s, r, a) {
                var l = e(t),
                    h = l.autoCallback;
                l.url.split(".").pop().split("?").shift(), l.bypass || (o && (o = n(o) ? o : o[t] || o[r] || o[t.split("/").pop().split("?")[0]]), l.instead ? l.instead(t, o, s, r, a) : (S[l.url] ? l.noexec = !0 : S[l.url] = 1, s.load(l.url, l.forceCSS || !l.forceJS && "css" == l.url.split(".").pop().split("?").shift() ? "c" : i, l.noexec, l.attrs, l.timeout), (n(o) || n(h)) && s.load(function() {
            ...
            if (o(t)) r(t, 0, u, 0);
                ...
                for (l = 0; l < t.length; l++) h = t[l], o(h) ? r(h, 0, u, 0) : E(h) ? f(h) : Object(h) === h && a(h, u);
        ...
        }, 0)), t.yepnope = c(), t.yepnope.executeStack = a, t.yepnope.injectJs = function(t, i, n, o, l, h) {
            var c, u, d = e.createElement("script"),
                o = o || f.errorTimeout;
            d.src = t;
            for (u in n) d.setAttribute(u, n[u]);
            i = h ? a : i || s, d.onreadystatechange = d.onload = function() {
            ...
            var h, o = e.createElement("link"),
                i = l ? a : i || s;
            o.href = t, o.rel = "stylesheet", o.type = "text/css";
            for (h in n) o.setAttribute(h, n[h]);
            r || (m.parentNode.insertBefore(o, m), p(i, 0))
        }
    ...
    function(t) {
        ...
        if (i.ajax = s, i.queue = n, i.unsupportedmq = r, i.regex = {
                media: /@media[^\{]+\{([^\{\}]*\{[^\}\{]*\})+/gi,
            ...
            var a, l, h, c = t.document,
                ...
                _ = function() {
                    var t, e = c.createElement("div"),
                        ...
                        s = !1;
                    return e.style.cssText = "position:absolute;font-size:1em;width:1em", i || (i = s = c.createElement("body"), i.style.background = "none"), u.style.fontSize = "100%", i.style.fontSize = "100%", i.appendChild(e), s && u.insertBefore(i, u.firstChild), t = e.offsetWidth, s ? u.removeChild(i) : i.removeChild(e), u.style.fontSize = n, o && (i.style.fontSize = o), t = h = parseFloat(t)
                },
                w = function(e) {
                    var i = "clientWidth",
                        n = u[i],
                        ...
                        r = b[b.length - 1],
                        m = (new Date).getTime();
                    if (e && a && g > m - a) return t.clearTimeout(l), void(l = t.setTimeout(w, g));
                    a = m;
                    for (var y in f)
                        if (f.hasOwnProperty(y)) {
                            var x = f[y],
                                ...
                                S = null === E,
                                k = "em";
                            C && (C = parseFloat(C) * (C.indexOf(k) > -1 ? h || _() : 1)), E && (E = parseFloat(E) * (E.indexOf(k) > -1 ? h || _() : 1)), x.hasquery && (P && S || !(P || o >= C) || !(S || E >= o)) || (s[x.media] || (s[x.media] = []), s[x.media].push(d[x.rules]))
                        }
                    ...
                    for (var T in s)
                        if (s.hasOwnProperty(T)) {
                            var N = c.createElement("style"),
                                H = s[T].join("\n");
                            N.type = "text/css", N.media = T, v.insertBefore(N, r.nextSibling), N.styleSheet ? N.styleSheet.cssText = H : N.appendChild(c.createTextNode(H)), p.push(N)
                        }
                },
                x = function(t, e, n) {
                    ...
                    for (var h = 0; s > h; h++) {
                        var c, u, p, m;
                        l ? (c = n, d.push(a(t))) : (c = o[h].match(i.regex.findStyles) && RegExp.$1, d.push(RegExp.$2 && a(RegExp.$2))), p = c.split(","), m = p.length;
                        for (var g = 0; m > g; g++) u = p[g], r(u) || f.push({
                ...
                E = function() {
                    for (var e = 0; e < b.length; e++) {
                        ...
                        o && r && !m[o] && (i.styleSheet && i.styleSheet.rawCssText ? (x(i.styleSheet.rawCssText, o, s), m[o] = !0) : (!/^([a-zA-Z:]*\/\/)/.test(o) && !y || o.replace(RegExp.$1, "").split("/")[0] === t.location.host) && ("//" === o.substring(0, 2) && (o = t.location.protocol + o), n.push({
                            href: o,
                            media: s
                        })))
                    }
            ...
            E(), i.update = E, i.getEmValue = _, t.addEventListener ? t.addEventListener("resize", e, !1) : t.attachEvent && t.attachEvent("onresize", e)
        }
    }(this), ! function(t, e) {
        function i(t, e) {
            var i = t.createElement("p"),
        ...
        function o(t, e) {
            var i = b.elements;
            "string" != typeof i && (i = i.join(" ")), "string" != typeof t && (t = t.join(" ")), b.elements = i + " " + t, h(e)
        }
        ...
        function r(t, i, n) {
            ...
            n || (n = s(i));
            var o;
            return o = n.cache[t] ? n.cache[t].cloneNode() : m.test(t) ? (n.cache[t] = n.createElem(t)).cloneNode() : n.createElem(t), !o.canHaveChildren || p.test(t) || o.tagUrn ? o : n.frag.appendChild(o)
        }
        ...
        function l(t, e) {
            e.cache || (e.cache = {}, e.createElem = t.createElement, e.createFrag = t.createDocumentFragment, e.frag = e.createFrag()), t.createElement = function(i) {
                return b.shivMethods ? r(i, t, e) : e.createElem(i)
            }, t.createDocumentFragment = Function("h,f", "return function(){var n=f.cloneNode(),c=n.createElement;h.shivMethods&&(" + n().join().replace(/[\w\-:]+/g, function(t) {
                return e.createElem(t), e.frag.createElement(t), 'c("' + t + '")'
            }) + ");return n}")(b, e.frag)
        }
        ...
        function h(t) {
            t || (t = e);
            var n = s(t);
            return !b.shivCSS || c || n.hasCSS || (n.hasCSS = !!i(t, "article,aside,dialog,figcaption,figure,footer,header,hgroup,main,nav,section{display:block}mark{background:#FF0;color:#000}template{display:none}")), u || l(t, n), t
        }
        var c, u, f = "3.7.2",
            d = t.html5 || {},
